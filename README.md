...
### Data Analyst • Business Intelligence • Machine Learning • Python • SQL • Power BI • AI
...
I transform raw data into **actionable insights, dashboards, predictive models, AI solutions, and better business decisions**.
...
![XGBoost](https://img.shields.io/badge/XGBoost-EB5B2D?style=for-the-badge)
![LightGBM](https://img.shields.io/badge/LightGBM-2E8B57?style=for-the-badge)
![SHAP](https://img.shields.io/badge/SHAP-Explainable_AI-5B5BD6?style=for-the-badge)
![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=for-the-badge&logo=jupyter&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white)

`Machine Learning` • `EDA` • `Predictive Modeling` • `Classification` • `Regression` • `Model Explainability` • `CRISP-DM`

### Business Intelligence

`Power Query` • `DAX` • `Data Modeling` • `Dashboard Design` • `KPI Development` • `Business Analysis`
...
`n8n` • `Supabase` • `Neon` • `SQLite` • `REST APIs` • `Automation`
...
I'm open to opportunities in **Data Analytics, Business Intelligence, Machine Learning, and AI**, where I can combine data, technology, and business understanding to support better decisions.
