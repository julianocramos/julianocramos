...
Customer churn analysis and prediction using **Python, Pandas, Matplotlib, and Scikit-learn**.

`EDA` `Customer Analytics` `Data Visualization` `Machine Learning` `Business Insights`
...
Netflix-inspired training platform modernized into a production-style Django application.

`Python` `Django` `PostgreSQL` `Neon` `Vercel` `Authentication`
...
Employee wellbeing platform combining digital reading, relaxation tools, interactive experiences, and a privacy-first approach.

`JavaScript` `Web Development` `Product Development`

➡️ [View Wellbeing Library](https://github.com/julianocramos/wellbeing-library)

---

### 🗄️ Database with Python

Python project demonstrating database connectivity and data access workflows.

`Python` `Database Connectivity` `Data Access`

➡️ [View Database with Python](https://github.com/julianocramos/Database_Python)
...
![Juliano's GitHub Stats](https://github-readme-stats.vercel.app/api?username=julianocramos&show_icons=true&hide_border=true&rank_icon=github)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=julianocramos&layout=compact&hide_border=true)

</div>

> GitHub language statistics reflect repository code composition and are not a measure of professional proficiency.
...
[![GitHub](https://img.shields.io/badge/GitHub-julianocramos-181717?style=for-the-badge&logo=github)](https://github.com/julianocramos)
